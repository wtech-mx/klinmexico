                            ...
                            <div class="tab-content" id="pills-tabContent">
                              ...
                              <div class="tab-pane fade" id="pills-Exito" role="tabpanel" aria-labelledby="pills-Exito-tab">
                                  <div class="content p-5">
                                     <p class="text-dark "> Servicio editado con éxito</p>

                                     <button class="btn btn-secondary" class="Servicios" onclick='myTab2()'><i class="fa fa-plus" aria-hidden="true"></i> Editar/Agregar Más Servicios</button>
