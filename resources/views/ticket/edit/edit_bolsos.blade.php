<!-- Modal -->
<div class="modal fade" id="exampleBolsos_{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel_{{ $item->id }}" aria-hidden="true">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-card text-black">
                                <div class="row">
                                    ...
                                    <div class="form-group mt-4 col-xs-12 col-md-3 col-lg-3">
                                        ...
                                        <div class="form-check">
                                            @if ($item->klin == 'Klin Bag')
                                                <input class="form-check-input" type="radio" name="klin" id="klin" value="Klin Bag" checked>
                                                <label class="form-check-label" for="servicio_primario1">
                                                    Klin Bag
                                                </label>
                                                @else
                                        ...
                                        <div class="form-check">
                                            @if ($item->klin == 'Klin Bag Extra')
                                                <input class="form-check-input" type="radio" name="klin" id="klin" value="Klin Bag Extra" checked>
                                                <label class="form-check-label" for="servicio_primario1">
                                                    Klin Bag Extra
                                                </label>
                                                @else
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mt-5 col-xs-12 col-md-12 col-lg-6">
                                    ...
                                    @if (!empty($item->DescripcionTicket))
                                        ...
                                        @enderror
                                    @else
                                        <input class="form-control @error('talla') is-invalid @enderror" type="text" name="talla" id="talla">
                                        @error('talla')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    @endif
                        ...
                        <div class="form-card text-black">
                            <div class="row">
                                ...
                                @foreach ($racks_bag as $bag)
                                @if ($bag->estatus == 1)
                                    @if ($bag->num_rack == $item->rack)
                                    <div class="form-group col-2">
                                        <input class="form-check-input" type="checkbox" value="{{$bag->num_rack}}" name="num_rack" id="num_rack" checked>
                                ...
                                @else
                                    <div class="form-group col-2">
                                        <input class="form-check-input" type="checkbox" value="{{$bag->num_rack}}" name="num_rack" id="num_rack">
                                        <label class="form-check-label" for="flexCheckDefault">
                                        {{$bag->num_rack}}
                                        </label>
                                    </div>
